...
export enum NotifyType {
    ...
    // NOTE: Print notifications were deprecated in 2.0.0
    PRINT = 0x02, // After v2.0.0: Reserved
    ALERT = 0x03, // After v2.0.0: Reserved
    LOG = 0x04, // After v2.0.0: Reserved
...
export const ERR_TYPE_MAP: Array<string> = [
...
export class TValPointer {
    ...
    public toString(): string {
        return this.size === 4
            ? `0x${this.toPaddedHex(this.lopart)}`
